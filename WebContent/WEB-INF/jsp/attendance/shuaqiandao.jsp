...
<body>
	<div class="row">
		...
		<div id="content" class="col-md-10 col-xs-10 col-sm-10"
			...
			<div id="ftdiv">
				<!-- <form class="form-horizontal" action="shua" method="post" enctype="multipart/form-data"> -->
				<form class="form-horizontal" action="shuaqiandao" method="post"
					enctype="application/x-www-form-urlencoded">
					<fieldset>
						<legend>注册新员工</legend>
						<div class="form-group has-feedback">
							<label class="control-label col-md-2 col-xs-2 col-sm-2">empId姓名:</label>
						...
						<div class="form-group has-feedback">
							<label class="control-label col-md-2 col-xs-2 col-sm-2">attendTime日期:</label>
							<div class="col-md-4 col-xs-4 col-sm-4 input-append date"
								id="datetimepicker1" data-date-format="yyyy-mm-dd">
								<input class="form-control" size="16" type="text"
									name="attendTime"> <span
									class="add-on form-control-feedback"><i
									class="icon-th glyphicon glyphicon-calendar"></i></span>
							</div>
						</div>
						<div class="form-group">
							<label class="control-label col-md-2 col-xs-2 col-sm-2">attendState邮箱:</label>
							<div class="col-md-4 col-xs-4 col-sm-4">
								<input type="text" name="attendState" class="form-control">
							</div>
