...
<body>
	<div class="row divtable">
		...
		<div id="content" class="col-md-10 col-xs-10 col-sm-10" style="padding-top: 0; margin: 0;">
			...
			<form class="form-inline" action="toDepListPage">
					<input type="search" name="deptId" class="form-control" placeholder="请输入部门编号" value="${param.deptId }">
					<input type="search" name="name" class="form-control" placeholder="请输入部门名称" value="${param.name }">
					...
					<tfoot>
						<tr >
							<td colspan="8" style="text-align: right;"> 
								<!-- 分页插件 -->
								<itheima:page url="${pageContext.request.contextPath }/toDepListPage" />
	      					</td>
						</tr>
					</tfoot>
				</table>
