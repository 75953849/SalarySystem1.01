...
<body>
	<div class="row">
		...
		<div id="content" class="col-md-10 col-xs-10 col-sm-10"
			...
			<div id="addDepart">
				<form class="form-horizontal" action="updateDepart" method="get">
					<fieldset>
						<legend>修改部门</legend>
						...
						<div class="form-group has-feedback">
							...
							<div class="col-md-4 col-xs-4 col-sm-4">
								<input type="text" name="departname" value="${dep.name }" class="form-control" >
						...
						<div class="form-group">
							...
							<div class="col-md-4 col-xs-4 col-sm-4">
								<textarea rows="5" cols="68" name="describe">${dep.describe }</textarea>
							</div>
						</div>
					</fieldset>
